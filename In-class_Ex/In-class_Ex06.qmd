...
## **7.0 Visually-driven hierarchical clustering analysis**
...
## 8.0 **Mapping the clusters formed**
...
::: callout-tip
`left_join()` require unique identifier to map between two objects to be merged. In this case, we can use `cbind()` to append the new cluser data to `shan.sf`obejct.
:::
...
## 9.0 **Spatially Constrained Clustering: SKATER approach**
...
### **9.6 Visualising the clusters in choropleth map**
...
### **10.1 A short note about ClustGeo package**
...
### **10.2 Ward-like hierarchical clustering: ClustGeo**
...
### **10.3** Mapping the clusters formed
...
## 11. **Spatially Constrained Hierarchical Clustering**
