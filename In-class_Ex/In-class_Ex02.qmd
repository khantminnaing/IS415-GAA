...
```{r}
#| eval: false
write_rds(origin_df, "~IS415-GAA/data/rds/origin_df.rds")
write_rds(destination_df, "~IS415-GAA/data/rds/destination_df.rds")
```
...
```{r}
#| eval: false
origin_df <- read_rds("~/IS415-GAA/data/rds/origin_df.rds")
