...
- lines, a “SpatialLinesDataFrame” (object defined in the sp package), representing the lines of
the network.
...
The parameters method, `kernel_name` and `bw`, indicate respectively which NKDE (simple, discontinuous, or continuous), and which kernel function (gaussian, quartic, triweight, etc.) to use, and the bandwidth of the kernel.
...
pg_lixels$nkde_continuous <- pg_nkde_continuous*1000
```
