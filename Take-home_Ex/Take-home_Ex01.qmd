...
Kernel estimation is implemented in **spatstat** by the function `density.ppp()`, a method for the
...
![Density Estimates with Different Smoothing Bandwidth (Ref, Baddeley et al., 2015)](images/Screenshot 2024-01-22 at 8.20.59 AM.png)

#### 7.2.1 Fixed Bandwidth

`density()` function of **spatstat** allows us to compute a kernel density for a given set of point events.

-   [`bw.diggle()`](https://search.r-project.org/CRAN/refmans/spatstat.explore/html/bw.diggle.html) (Cross Validated)
...
-   [`bw.scott()`](https://www.rdocumentation.org/packages/spatstat/versions/1.64-1/topics/bw.scott) (Scott\'s Rule)

-   [`bw.ppl()`](https://search.r-project.org/CRAN/refmans/spatstat.explore/html/bw.pplHeat.html) (Likelihood Cross Validation)can also be used.
...
The commands used for generating bandwidth return a numerical value, the optimised bandwidth, which also belongs to the special class `bw.optim.`
