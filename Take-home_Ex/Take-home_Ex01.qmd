...
![Density Estimates with Different Smoothing Bandwidth (Ref, Baddeley et al., 2015)](images/Screenshot%202024-01-22%20at%208.20.59%20AM.png){alt="Density Estimates with Different Smoothing Bandwidth (Ref, Baddeley et al., 2015)"}
...
```{r}
hist(kde_destination_dirichlet_adaptive,main = "Voronoi-Dirichlet Adaptive Density Estimate")
```
...
```{r}
hist(kde_destination_kernel_adaptive,main = "Adaptive Kernel Density Estimate")
```
...
```{r}
hist(kde_adaptive_nn,main = "Nearest-Neighbour Adaptive Density Estimate")
```
