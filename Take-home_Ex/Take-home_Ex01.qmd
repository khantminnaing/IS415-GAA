...
#### 7.3.1 Creating KDE Layers with Fixed Bandwidth

#### 7.3.1.1 Computing Fixed Bandwidths Using Different Bandwidth Selection Methods
...
#### 7.3.1.2 Plotting Fixed-Bandwidth KDE Layers 
...
#### 7.3.1.3 Choosing Fixed KDE Bandwidth Selection Method
...
#### 7.3.2 Creating KDE Layers with Spatially Adaptive Bandwidth
...
#### 7.3.2.1 Dirichlet-type Adaptive Density Estimate
...
#### 7.3.2.2 Nearest-Neighbour Density Estimate
