...
```{r}
pacman::p_load(arrow,lubridate,tidyverse,tmap,sf,st,spatstat,patchwork,raster,spNetwork)
```
...
tm_shape(pg_lixels)+
  tm_lines(col="density", palette =c("#fafac3","#fd953b","#f02a75","#b62385","#021c9e"))+
