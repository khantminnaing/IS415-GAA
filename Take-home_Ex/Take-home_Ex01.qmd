...
tm_basemap(server = "OpenStreetMap") +
  ...
  tm_shape(mpsz_sf)+
  tm_polygons(alpha=0.3,id="PLN_AREA_N")+
...
destination_wl_ppp = destination_ppp_sg.km[wl_owin]
destination_je_ppp = destination_ppp_sg.km[je_owin]
destination_jw_ppp = destination_ppp_sg.km[jw_owin]
destination_tp_ppp = destination_ppp_sg.km[tp_owin]
```

```{r}
wl_kde_scott <- density(destination_wl_ppp, sigma=0.01, main="Woodlands")
je_kde_scott <- density(destination_je_ppp, sigma=0.01, main="Jurong East")
jw_kde_scott <- density(destination_jw_ppp, sigma=0.01, main="Jurong West")
tp_kde_scott <- density(destination_tp_ppp, sigma=0.01, main="Tampines")
