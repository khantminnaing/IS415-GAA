...
+------------------+-------------------------------------------------------------------------------------------------------------------------+
| Area of Interest | -   `NA` if `Overall (Singapore)` is selected for **Zooming Level**                                                     |
|                  |                                                                                                                         |
...
![](images/31.png){fig-align="center"}
...
![](images/33.png){fig-align="center"}
...
![](images/32-01.png){fig-align="center"}
...
![Inflow/Outflow Map - (Flow Type) Incoming Flow, (Time Period) Weekday - Morning, (Zooming Level) - Overall Singapore, (Area of Interest) NA](images/Inflow_Outflow%20Map%20(2).png){fig-align="center"}

![Inflow/Outflow Map - (Flow Type) Outgoing Flow, (Time Period) Weekday - Morning, (Zooming Level) - Overall Singapore, (Area of Interest) NA](images/Inflow_Outflow%20Map%20(3).png){fig-align="center"}

### 5.1.2 Inflow/Outflow Map for Planning Area/Subzone Zooming

![Inflow/Outflow Map - (Flow Type) Incoming Flow, (Time Period) Weekday - Morning, (Zooming Level) - Planning Area, (Area of Interest) Bukit Panjang](images/Trip%20Count%20Map-01.png){fig-align="center"}

![Inflow/Outflow Map - (Flow Type) Incoming Flow, (Time Period) Weekday - Morning, (Zooming Level) - Subzone, (Area of Interest) Changi Airport](images/Inflow_Outflow%20Map-02.png){fig-align="center"}

![Inflow/Outflow Map - (Flow Type) Outgoing Flow, (Time Period) Weekday - Morning, (Zooming Level) - Subzone, (Area of Interest) Tuas North](images/Inflow_Outflow%20Map%20(6).png){fig-align="center"}

## 5.2 Flow Estimation Map

### 5.2.1 Origin-Constrained Flow Estimation Maps

![Flow Estimation Map - (Model Type) Origin-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[O-D Desire Line, Fitted Outflow Map\], (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Flow%20Estimation%20Map.png){fig-align="center"}

![Flow Estimation Map - (Model Type) Origin-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[O-D Desire Line\], (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Flow%20Estimation%20Map%20(2).png){fig-align="center"}

![Flow Estimation Map - (Model Type) Origin-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[Fitted Outflow Map\], (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Flow%20Estimation%20Map%20(3).png){fig-align="center"}

![Flow Estimation Map - (Model Type) Origin-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[Fitted Inflow Map\], (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Flow%20Estimation%20Map%20(4).png){fig-align="center"}

### 5.2.2 Destination-Constrained Flow Estimation Maps

![Flow Estimation Map - (Model Type) Destination-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[O-D Desire Line, Fitted Inflow Map\], (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Destination-Constrained%201.png){fig-align="center"}

![Flow Estimation Map - (Model Type) Destination-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[O-D Desire Line\], (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Destination-Constrained%202.png){fig-align="center"}

![Flow Estimation Map - (Model Type) Destination-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[O-D Desire Line, Fitted Inflow Map\], (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Destination-Constrained%202.png){fig-align="center"}

![Flow Estimation Map - (Model Type) Destination-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[O-D Desire Line\], (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Destination-Constrained%202.png){fig-align="center"}

![Flow Estimation Map - (Model Type) Destination-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[Fitted Outflow Map\], (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Destination-Constrained%203.png){fig-align="center"}

### 5.2.3 Doubly-Constrained Flow Estimation Maps

![Flow Estimation Map - (Model Type) Doubly-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[O-D Desire Line, Fitted Inflow Map\], (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Doubly-Constrained%201.png){fig-align="center"}

![Flow Estimation Map - (Model Type) Doubly-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[O-D Desire Line\], (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Doubly-Constrained%202.png){fig-align="center"}

![Flow Estimation Map - (Model Type) Doubly-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[Fitted Outflow Map\], (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Doubly-Constrained%203.png){fig-align="center"}

### 5.2.4 Flow Estimation Maps for Planning Area/Subzone Zooming

![Flow Estimation Map - (Model Type) Destination-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[O-D Desire Line, Fitted Inflow Map, Fitted Outflow Map\], (Zooming Level) Planning Area, (Area of Interest) Woodlands](images/Planning%20Area.png){fig-align="center"}

![Flow Estimation Map - (Model Type) Destination-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[Fitted Inflow Map\], (Zooming Level) Planning Area, (Area of Interest) Woodlands](images/Planning%20Area%20(2).png){fig-align="center"}

![Flow Estimation Map - (Model Type) Destination-Constrained, (Time Period) Weekday - Morning, (Result Layer) \[O-D Desire Line\], (Zooming Level) Subzone, (Area of Interest) Tuas North](images/Subzone-01.png){fig-align="center"}

## 5.3 Push-Pull Factors

![Push-Pull Factors - (Time Period) Weekday - Morning, (Zooming Level) Overall Singapore, (Area of Interest) NA](images/Push-Pull-01.png){fig-align="center"}
